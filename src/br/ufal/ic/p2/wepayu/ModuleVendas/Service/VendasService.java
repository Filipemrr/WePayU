...
import static br.ufal.ic.p2.wepayu.ModuleVendas.Service.VendasValidations.*;
...
public class VendasService {
    ...
    public static void LancaVenda(String id, String data, String Valor) throws  Exception {
    ...
    public static String GetVendasRealizadas(String id, String DataInicial, String DataFinal) throws Exception {
