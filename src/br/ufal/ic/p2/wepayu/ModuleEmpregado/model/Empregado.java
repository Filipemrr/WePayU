...
public class Empregado {
    ...
    public Boolean getIsComissionado() {
        return isComissionado;
    }

    public void setComissao(String NovaComissao) {
    ...
    public void setMetodoDePagamento(String pagamento) {
        this.metodoDePagamento = pagamento;
    }
    ...
    public boolean isRecebedorPorBanco() {
        return isRecebedorPorBanco;
    }

    public void setisRecebedorPorBanco(boolean valor) {
        this.isRecebedorPorBanco = valor;
    }

    public Boolean getIsSindicalizado() {
        return isSindicalizado;
    }

    public void SetisSindicalizado(boolean valor) {
        isSindicalizado = valor;
    }

    public void SetTipo(String atributo) {
        this.tipo = atributo;
    }
