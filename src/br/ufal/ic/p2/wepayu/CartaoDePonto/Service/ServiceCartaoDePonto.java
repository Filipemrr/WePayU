...
public class ServiceCartaoDePonto {
    ...
    public static void LancaCartao(String id, String data, String horasString) throws ExceptionHoras {
    ...
    public static String GetHorasNormaisTrabalhadas(String id, String dataInicial, String dataFinal) throws ExceptionHoras {
